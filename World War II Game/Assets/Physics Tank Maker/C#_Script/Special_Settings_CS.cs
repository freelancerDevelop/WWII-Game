...
namespace ChobiAssets.PTM
{
	...
	public class Special_Settings_CS : MonoBehaviour
	{
		...
		*/
		...
		void Send_Settings()
		{
			// Set "Attack_Multiplier" values of all the "Bullet_Generator_CS" in the tank.
			...
			// Apply the "Defence_Multiplier" to the hit points values of the "Damage_Control_Center_CS" in the tank.

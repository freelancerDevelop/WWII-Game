...
namespace ChobiAssets.PTM
{
	...
	public class Event_Controller_CSEditor : Editor
	{
		...
		SerializedProperty Share_TargetProp;
		...
		SerializedProperty New_Share_TargetProp;
		...
		void OnEnable ()
		{
			...
			Share_TargetProp = serializedObject.FindProperty ("Share_Target");
			...
			New_Share_TargetProp = serializedObject.FindProperty ("New_Share_Target");
			...
			if (EditorApplication.isPlaying == false) {
				...
				switch (Event_TypeProp.intValue) {
					case 0: // Spawn Tank
						...
						EditorGUILayout.Slider (Attack_MultiplierProp, 0.1f, 10.0f, "Attack Multiplier");
						EditorGUILayout.Slider (Defence_MultiplierProp, 0.1f, 10.0f, "Defence Multiplier");
						GUI.backgroundColor = new Color (1.0f, 1.0f, 0.5f, 1.0f);
						EditorGUILayout.Space ();
						...
						if (prefabObject && prefabObject.GetComponentInChildren <AI_CS> ()) {
							...
							Share_TargetProp.objectReferenceValue = EditorGUILayout.ObjectField ("Share Target", Share_TargetProp.objectReferenceValue, typeof(Transform), true);
					...
					case 2: // Change AI Settings
						...
						New_Share_TargetProp.objectReferenceValue = EditorGUILayout.ObjectField ("Share Target", New_Share_TargetProp.objectReferenceValue, typeof(Transform), true);

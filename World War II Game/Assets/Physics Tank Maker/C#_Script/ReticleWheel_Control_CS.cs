...
namespace ChobiAssets.PTM
{
	public class ReticleWheel_Control_CS : MonoBehaviour
	{
		...
		*/
		...
		{
			float targetDistance = Vector3.Distance(thisTransform.position, aimingScript.Target_Position) * Multiplier;
			...
			Vector3 currentLocalAngles = reticleWheelTransform.localEulerAngles;

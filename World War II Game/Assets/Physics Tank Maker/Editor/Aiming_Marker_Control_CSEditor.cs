...
namespace ChobiAssets.PTM
{
	...
	public class UI_Aim_Marker_Control_CS_CSEditor : Editor
	{
		...
		public override void OnInspectorGUI ()
		{
			...
			EditorGUILayout.HelpBox ("Aiming Marker settings", MessageType.None, true);

			Aim_Marker_NameProp.stringValue = EditorGUILayout.TextField ("Aiming Marker Name", Aim_Marker_NameProp.stringValue);

	...
	public class AI_Settings_CSEditor : Editor
	{
		...
		public override void OnInspectorGUI ()
		{
			...
			if (EditorApplication.isPlaying == false) {
				...
				WayPoint_PackProp.objectReferenceValue = EditorGUILayout.ObjectField("Way Point Pack", WayPoint_PackProp.objectReferenceValue, typeof(GameObject), true);
			...
			EditorGUILayout.Space ();
			EditorGUILayout.HelpBox ("AI Conbat settings", MessageType.None, true);

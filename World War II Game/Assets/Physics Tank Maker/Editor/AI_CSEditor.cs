...
namespace ChobiAssets.PTM
{
	...
	public class AI_CSEditor : Editor
	{
		...
		public override void OnInspectorGUI ()
		{
			...
			EditorGUILayout.Slider (Agent_DistanceProp, 0.0f, 16.0f, "Agent Distance");
			EditorGUILayout.Slider (Agent_Additional_DistanceProp, 0.0f, 16.0f, "Agent Additional Distance");
			EditorGUILayout.Space ();

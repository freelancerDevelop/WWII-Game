...
namespace ChobiAssets.PTM
{
	...
	public class Emission_Control_CSEditor : Editor
	{
		...
		public override void OnInspectorGUI ()
		{
			...
			Reference_RigidbodyProp.objectReferenceValue = EditorGUILayout.ObjectField ("Reference Rigidbody", Reference_RigidbodyProp.objectReferenceValue, typeof(Rigidbody), true);
